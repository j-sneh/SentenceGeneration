...
string help() {
     ...
     cout << "To generate the highest weight sentence(**):\t\t\"1\"" << endl;
     cout << "To generate a greedy highest-weight sentence:\t\t\"2\"" << endl;
     cout << "To generate a greedy lowest-weight sentence:\t\t\"3\"" << endl;
     cout << "To generate a probabilistic sentence:\t\t\t\"4\"" << endl;
     cout << "To generate a completely random sentence:\t\t\"5\"" << endl;
     cout << "To view words that are n-degrees away (BFS):\t\t\"6\"" << endl;
     cout << "To view the graph as adjacency lists:\t\t\t\"7\"" << endl;
